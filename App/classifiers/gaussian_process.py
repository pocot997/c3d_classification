...
TRAIN_DIR = r"C:\Repos\Mgr\data_random_long\data_markers\complete"
TEST_DIR = r"C:\Repos\Mgr\data_random_long\data_markers\complete"
...
for attempt in attempts:
    ...
    if(counter == 0):
        with open(TRAIN_DIR + r"\gaussian_process.txt", 'w') as file:
            file.write(content + '\n')
    else:
        with open(TRAIN_DIR + r"\gaussian_process.txt", 'a') as file:
            file.write(content + '\n')
