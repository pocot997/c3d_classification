...
TRAIN_DIR = r"C:\Repos\Mgr\data_random\data_markers\complete"
TEST_DIR = r"C:\Repos\Mgr\data_random\data_markers\complete"
...
for attempt in attempts:
    ...
    if(counter == 0):
        with open(TRAIN_DIR + r"\logistic_regression.txt", 'w') as file:
            file.write(content + '\n')
    else:
        with open(TRAIN_DIR + r"\logistic_regression.txt", 'a') as file:
            file.write(content + '\n')
